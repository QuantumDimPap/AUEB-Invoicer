...
If you then want to run Tensorboard to see the graphs that are produced after running the application (or the ones attached here), that provide the accuracy and the structure of each model head in the terminal and type (provided that you are located into the folder AUEB Invoicer):
